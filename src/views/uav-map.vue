<template>
  <section class="mainbox">
    <div class="column">
      <div class="panel bar">
        <h2>
          因自然灾害断网人数 <a href="javascript:;">2019</a>
          <a href="javacript:;"> 2020</a>
        </h2>
        <div class="chart" ref="pic2"></div>
        <div class="panel-footer"></div>
      </div>
      <div class="panel line">
        <h2>受灾人数变化</h2>
        <div class="chart" ref="pic3"></div>
        <div class="panel-footer"></div>
      </div>
      <div class="panel pie">
        <h2>自然灾害中出现大规模断网的情况</h2>
        <div class="chart" ref="pic4"></div>
        <div class="panel-footer"></div>
      </div>
    </div>
    <div class="column">
    ...
    <div class="column">
      <div class="panel bar1">
        <h2>救灾方案的应用</h2>
        <div class="chart" ref="pic5"></div>
        <div class="panel-footer"></div>
      </div>
      <div class="panel line1">
        <h2>每年灾害数量</h2>
        <div class="chart" ref="pic6"></div>
        <div class="panel-footer"></div>
      </div>
      <div class="panel pie1">
        <h2>发生灾害地区统计</h2>
        <div class="chart" ref="pic7"></div>
        <div class="panel-footer"></div>
      </div>
    </div>
  </section>
...
onMounted(() => {
  ...
  // 实例化对象
  var myChart = echarts.init(pic2.value)
  // 指定配置和数据
  var option = {
    color: ['#2f89cf'],
    tooltip: {
  ...
  var myChart = echarts.init(pic3.value)
  ...
  // 基于准备好的dom，初始化echarts实例
  var myChart = echarts.init(pic4.value)
  ...
  // 基于准备好的dom，初始化echarts实例
  var myChart = echarts.init(pic6.value)
  ...
  // 1. 实例化对象
  var myChart = echarts.init(pic7.value)
  // 2. 指定配置项和数据
  var option = {
    legend: {
      top: '90%',
